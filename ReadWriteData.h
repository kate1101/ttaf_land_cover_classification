...
public:
    ...
    bool writeClassDefault(const string& fileNameIn, const string& fileNameOut, vector<LasPoint>& points);
    bool writeClassAlg(const string& fileNameIn, const string& fileNameOut, vector<LasPoint>& points, bool alg1);
